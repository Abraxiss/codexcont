...
<nav class="navbar navbar-expand-lg navbar-primary " style="background: black";>
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="nav-link active" href="asiento_ingresos.php"><i class="fas fa-plus-circle"></i> &nbsp INGRESOS</a>
          <a class="nav-link" href="asiento_egresos.php"> <i class="fas fa-minus-circle"></i> &nbsp EGRESOS</a>

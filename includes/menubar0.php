...
<nav class="navbar navbar-expand-lg navbar " style="background: black";>
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="nav-link" href="op_apertura_invent.php"> <i class="fas fa-tasks"></i> &nbsp INVENTARIO</a>
          <a class="nav-link active" href="./sindatos.php"><i class="fas fa-plus-circle"></i> &nbsp INGRESOS</a>
          <a class="nav-link" href="./sindatos.php"> <i class="fas fa-minus-circle"></i> &nbsp EGRESOS</a>
          <a class="nav-link" href="op_apertura.php"> <i class="fas fa-columns"></i> &nbsp BALANCE INICIAL</a>
          <div class="dropdown-divider " style="background:white;"></div>
          
          <a class="nav-link" href="./sindatos.php"> <i class="fas fa-trash-alt"></i> &nbsp ELIMINAR</a>
        </div>
      </li>
     ...
     <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="nav-link" href="./sindatos.php"> <i class="fas fa-th-list"></i> &nbsp BALANCE GENERAL</a>
          <a class="nav-link active" href="./sindatos.php"> <i class="fas fa-th-list"></i> &nbsp RESULTADOS OBTENIDOS</a>
          <div class="dropdown-divider" style="background:white;"></div>
          
          <a class="nav-link" href="./sindatos.php"> <i class="fas fa-th-list"></i> &nbsp RATIOS FINANCIEROS</a>
        </div>
      </li>

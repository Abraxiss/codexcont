...
<div class="bodyform">
  <form action="crud_venta/create.php" method="GET" >

  <img class="tituloop" src="img/nregistro/C.png" width="50" alt="logo">
  <h3>CAPITAL OBTENIDO</h3>
    ...
    <div class="seccion">
      ...
      <div class="opciones">
        ...
        <label class="opcion">
          ...
          <img src="img/nregistro/M.png" alt="Crédito">
          <span>MARCEDERIA</span>
        </label>
        <label class="opcion">
          <input type="radio" name="condicion" value="credito">
          <img src="img/nregistro/B.png" alt="Crédito">
          <span>BIENES</span>
        </label>        
      </div>
    </div>
